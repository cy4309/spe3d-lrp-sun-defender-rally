...
export const SIGNBOARD_BORDER_GRADIENT = "linear-gradient(180deg, #f47a1f 0%, #e86a10 18%, #4a7ab0 52%, #003e89 100%)";
...
export default function Signboard({ children, className = "" }: SignboardProps) {
  return (
    <div className={`rounded-[20px] p-[3px] shadow-[0_8px_32px_rgba(0,0,0,0.28)] ${className}`} style={{ background: SIGNBOARD_BORDER_GRADIENT }}>
